...
#imagee=Image.open('E:/freelancer/biomecanica/gato.gif')
imagee=Image.open('E:/freelancer/biomecanica/gato.gif').convert('LA')
imagee=asarray(imagee)
print('   inagen     ',type(imagee))
# perform skeletonization
skeleton = skeletonize(imagee)
